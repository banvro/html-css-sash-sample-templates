                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <div class="card border p-0 shadow-none">
                                            <div class="card-body">
                                                ...
                                                <div class="mt-4">
                                                    <div class="d-flex">
                                                        <img src="../assets/images/media/22.jpg" alt="img" class="w-40 m-1 br-5">
                                                        <img src="../assets/images//media/24.jpg" alt="img" class="w-40 m-1 br-5">
                                                    </div>
                                                    <h4 class="fw-semibold mt-3">There is nothing more beautiful.</h4>
                                                    <p class="mb-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.
                                                    </p>
                                        ...
                                        <div class="card border p-0 shadow-none">
                                            <div class="card-body">
                                                ...
                                                <div class="mt-4">
                                                    <div class="d-flex">
                                                        <img src="../assets/images/media/26.jpg" alt="img" class="w-30 m-1 br-5">
                                                        <img src="../assets/images/media/23.jpg" alt="img" class="w-30 m-1 br-5">
                                                        <img src="../assets/images/media/21.jpg" alt="img" class="w-30 m-1 br-5">
                                                    </div>
                                                    <h4 class="fw-semibold mt-3">There is nothing more beautiful.</h4>
                                                    <p class="mb-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.
                                                    </p>
